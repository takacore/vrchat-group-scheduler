...
> 更新時のデータ引き継ぎ: v2.2.0 以降は固定の拡張機能 ID を使用するため、ZIP を別フォルダへ展開して読み込み直しても、予約投稿・グループ権限キャッシュ・言語設定が自動的に引き継がれます。rc.7 以前から初めて v2.2.0 へ更新する場合だけは、現在 Chrome に読み込ませているフォルダへ上書きして「更新」してください。別PCへ移す場合は、引き続き **Backup / Restore** をご利用ください。
